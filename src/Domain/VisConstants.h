...
static const bool k_default_overlay_bgv_enabled = false;
static const std::string k_default_overlay_bgv_command{""};
static const uint32_t k_default_overlay_bgv_poll_ms = 1000;
static const bool k_default_overlay_flight_enabled = false;
static const std::string k_default_overlay_flight_command{""};
static const uint32_t k_default_overlay_flight_poll_ms = 15000;
static const uint32_t k_default_overlay_flight_width = 0;
static const std::wstring k_default_overlay_flight_plane_left{L"\u2B9C"};
static const std::wstring k_default_overlay_flight_plane_right{L"\u2B9E"};
static const bool k_default_overlay_baiyan_enabled = false;
static const std::string k_default_overlay_baiyan_command{""};
static const uint32_t k_default_overlay_baiyan_poll_ms = 60000;
static const uint32_t k_default_overlay_baiyan_width = 0;
static const bool k_default_overlay_status_enabled = false;
static const std::string k_default_overlay_status_command{""};
static const uint32_t k_default_overlay_status_poll_ms = 60000;
